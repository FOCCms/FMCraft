// ====== LAUNCHER CONFIG ====== //
var config = {
    dir: ".FMCraft", // Launcher directory
    title: "FMCraft Launcher", // Window title
    icons: [ "favicon.png" ], // Window icon paths

    // Auth config
    newsURL: "http://fmcraft.ru/", // News WebView URL
    linkText: "Регистрация", // Text for link under "Auth" button
    linkURL: new java.net.URL("http://fmcraft.ru/?mode=register"), // URL for link under "Auth" button
